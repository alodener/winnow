...
<main class="page-wrapper">
    <header class="header navbar navbar-expand-lg navbar-light bg-light shadow-sm shadow-dark-mode-none {{request()->routeIs('dashboard.perfil.index')||request()->routeIs('dashboard.enderecos.index')?"fixed-top":""}}">
        <div class="container">
            <a href="{{route('home')}}" class="navbar-brand">
                <img src="/imagem/logo/logo_full.png" width="150" alt="{{ config('app.name', 'Laravel') }}">
            </a>
            ...
            <nav id="navbarCollapse5" class="collapse navbar-collapse order-lg-2">
                ...
                <ul class="navbar-nav me-auto">
                    @if(Auth::user()->type == 'admin')
                        <li class="nav-item">
                            <a href="/admin" class="nav-link fw-bold text-warning">ADMIN</a>
                        </li>
                    @endif
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{route('dashboard.redes.diretos')}}" class="nav-link {{request()->routeIs('dashboard.redes.diretos')?'active':''}}">Afiliados</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('dashboard.cursos.index')}}" class="nav-link {{request()->routeIs('dashboard.cursos.index')?'active':''}}">Cursos</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('dashboard.produtos.index')}}" class="nav-link {{request()->routeIs('dashboard.produtos.index')?'active':''}}">Planos</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('clientTickets')}}" class="nav-link {{request()->routeIs('clientTickets')?'active':''}}">Suporte</a>
                    </li>
                </ul>
            </nav>
        </div>
    </header>
    @if(!request()->routeIs('dashboard.cursos.show'))
        <nav class="container mb-4 mt-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                @yield('breadcrumb')
            </ol>
        </nav>
        ...
        <div class="row pb-5">
            <div class="col-lg-4 col-md-6">
                <div class="navbar-brand text-dark p-0 me-0 mb-3 mb-lg-4">
                    <img src="/imagem/logo/logo_full.png" width="200" alt="{{ config('app.name', 'Laravel') }}">
                </div>
